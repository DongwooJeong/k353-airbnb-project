...
# booking regression
reg_bookingQ3 = lm(formula = NumReserveDays2016Q3 ~ ResponseRate + OverallRating + NumberofReviews + LogPNR + LogPMR + 
...
# price regression
reg_priceQ3 = lm(formula = Price2016Q3 ~ NumberofReviews + ResponseRate + Bathrooms + PublishedMonthlyRate + 
